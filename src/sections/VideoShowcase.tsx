      ...
      <div className='container mx-auto px-4'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='relative'>
            ...
            <button
              onClick={() => scroll("left")}
              className='absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-gray-50 text-black hover:text-black p-3 rounded-full shadow-lg transition-all duration-200 border border-gray-200'
            ...
            <button
              ...
              className='absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-gray-50 text-black hover:text-black p-3 rounded-full shadow-lg transition-all duration-200 border border-gray-200'
